...
public class DefaultErrorMailTest {

	private ErrorMail defaultErrorMail = new DefaultErrorMail("test", "my stack", "/my/url", "my=param", null,
			"mailinglist@list.com", "vraptor@vraptor", "vraptor", "header-key: value\n");

	@Test
	public void should_not_show_parameters_if_its_empty() {
		ErrorMail errorMail = new DefaultErrorMail("test", "my stack", "/my/url", "", null, "mailinglist@list.com",
